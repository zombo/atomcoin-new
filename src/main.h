...
public:
    ...
    */
    ...
    /** Amount of atomcoins spent by this transaction.
    ...
    /** Amount of atomcoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at atomcoin block #9689
        if (nHeight >= 9689)
        {
        ...
        // Before atomcoin block #9689 - old protocol
